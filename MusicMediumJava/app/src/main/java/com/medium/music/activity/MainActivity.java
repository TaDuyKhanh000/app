...
import com.medium.music.fragment.AdminFeedbackFragment;
...
//Phương thức này mở màn hình phản hồi (feedback) và thay đổi giao diện dựa trên
// quyền của người dùng (admin hoặc User)
...
//Cập nhật tiêu đề trên thanh toolbar để người dung biết đang ở trong feetback
        initToolbar(getString(R.string.menu_feedback));
        displayLayoutPlayAll();
    }
// Phương thức này mở màn hình liên hệ (contact screen) và thay đổi giao diện của ứng dụng
    private void openContactScreen() {
        replaceFragment(new ContactFragment());
        mTypeScreen = TYPE_CONTACT;
// Cập nhật tiêu đề trên thanh toolbar để người dung biết đang ở trong contact
