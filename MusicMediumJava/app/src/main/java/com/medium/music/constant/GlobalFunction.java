...
import com.medium.music.service.MusicReceiver;
...
//với địa chỉ email định sẵn mở hộp thoại email để gửi thư
...
//    Trước tiên, kiểm tra xem ứng dụng Skype có được cài đặt trên thiết bị hay không bằng getPackageManager().getPackageInfo
//    Nếu ứng dụng Skype có mặt, tạo một Intent để mở ứng dụng với thông tin trò chuyện.
...
//     Nếu không tìm thấy ứng dụng Skype, phương thức openSkypeWebview sẽ được gọi để mở Skype qua web.
